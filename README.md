...
Package Analysis project](https://github.com/khulnasoft-lab/package-analysis).
...
[create an issue](https://github.com/khulnasoft-lab/malicious-packages/issues/new).
