...
func TestPath(t *testing.T) {
	tests := []struct {
		...
		{
			name:      "github.com/khulnasoft-labs/infected-packages/cmd/ingest",
			ecosystem: "Go",
			want:      "go/github.com/khulnasoft-labs/infected-packages/cmd/ingest",
		},
		{
...
func TestNormalize_Summary(t *testing.T) {
	...
	want := "infected-packages code in example (RubyGems)"
